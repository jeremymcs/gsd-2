...
**Related:** [ADR-004](./ADR-004-capability-aware-model-routing.md) (capability-aware model routing), [ADR-005](https://github.com/gsd-build/gsd-2/issues/2790), [ADR-006](./ADR-006-extension-modularization.md), `packages/pi-ai/src/providers/`, `packages/pi-ai/src/models.ts`
